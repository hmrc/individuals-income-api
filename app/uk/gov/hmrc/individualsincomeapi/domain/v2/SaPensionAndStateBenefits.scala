...
case class SaPensionAndStateBenefits(taxReturns: Seq[SaPensionAndStateBenefitsTaxReturn])

object SaPensionAndStateBenefits {

  implicit val saPensionAndStateBenefitsJsonFormat: OFormat[SaPensionAndStateBenefits] =
    Json.format[SaPensionAndStateBenefits]
