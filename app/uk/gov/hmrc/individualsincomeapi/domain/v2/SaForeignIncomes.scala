...
case class SaForeignIncomes(taxReturns: Seq[SaForeignTaxReturn])

object SaForeignIncomes {

  implicit val saForeignIncomesJsonFormat: OFormat[SaForeignIncomes] = Json.format[SaForeignIncomes]
