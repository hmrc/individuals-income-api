...
object SandboxIncomeData {
  ...
  private def amanda() = Individual(
    ...
    Seq(
      DesSAIncome("2014", Seq(DesSAReturn(parse("2012-01-06"), parse("2014-06-06"), Some(sandboxUtr), Some(5000), Some(10500), Some(30000)))),
      DesSAIncome("2015", Seq(DesSAReturn(parse("2012-01-06"), parse("2015-10-06"), Some(sandboxUtr))))
    )
  )
}
