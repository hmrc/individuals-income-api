...
case class IfSaApiResponseEventModel(
  deviceId: String,
  input: String,
  method: String,
  userAgent: String,
...
object IfSaApiResponseEventModel {
  implicit val formatIfSaApiResponseEventModel: OFormat[IfSaApiResponseEventModel] =
    Json.format[IfSaApiResponseEventModel]
}
