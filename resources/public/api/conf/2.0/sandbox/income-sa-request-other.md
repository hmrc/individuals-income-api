<table>
    ...
    <tbody>
    <tr>
        <td><p>A valid, successful request for other income data</p></td>
    ...
    <tr>
         <td><p>fromTaxYear is earlier than the current tax year minus 6.</p></td>
         <td>
            <p>The fromTaxYear is earlier than the current tax year minus 6.</p>
            <p>For example:</p><p>fromTaxYear=2014-01-01</p>
         </td>
         <td>
           <p>400 (Bad Request)</p>
    ...
    <tr>
         ...
         <td>
            <p>400 (Bad Request)</p>
            <p>{ &quot;code&quot; : &quot;INVALID_REQUEST&quot;,<br/>&quot;message&quot; : &quot;fromTaxYear: invalid tax year format&quot; 
}</p>
