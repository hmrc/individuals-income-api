<table>
    ...
    <tr>
         ...
         <td><p>Any valid dates where the toTaxYear is earlier than the fromTaxYear.</p><p>For example, fromTaxYear=2018-19 toTaxYear=2019-20</p></td>
         <td>
            <p>400 (Bad Request)</p>
    ...
    <tr>
         ...
         <td><p>The toTaxYear is later than the current tax year.</p><p>For example, fromTaxYear=2016-17 toTaxYear=2098-99</p></td>
