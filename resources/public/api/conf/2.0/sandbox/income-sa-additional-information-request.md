<table>
    ...
    <tr>
         ...
         <td><p>Any valid dates where the toTaxYear is earlier than the fromTaxYear.</p>
         <p>For example:</p><p>fromTaxYear=2019-20 toTaxYear=2018-19</p></td>
    ...
    <tr>
         ...
         <td>
            ...
            <p>For example:</p><p>fromTaxYear=2016-17 toTaxYear=2098-99</p>
         </td>
         <td><p>400 (Bad Request)</p>
    ...
    <tr>
         ...
         <td>
            ...
            <p>For example:</p><p>fromTaxYear=2013-2014</p>
         </td>
         <td>
           <p>400 (Bad Request)</p>
