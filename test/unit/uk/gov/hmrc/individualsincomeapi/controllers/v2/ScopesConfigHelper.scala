...
trait ScopesConfigHelper {
  ...
  val mockScopesConfig = Configuration(
    ...
    (s"api-config.endpoints.incomeSa.endpoint", "/individuals/income/sa?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/summary?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/trusts?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/foreign?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/partnerships?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/interests-and-dividends?matchId=<matchId>{&startDate,endDate}"),
    (
    ...
    (
      ...
      "/individuals/income/sa/pensions-and-state-benefits?matchId=<matchId>{&startDate,endDate}"),
    (
    ...
    (
      ...
      "/individuals/income/sa/uk-properties?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/additional-information?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/other?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/source?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/employments?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/self-employments?matchId=<matchId>{&startDate,endDate}"),
    ...
    (
      ...
      "/individuals/income/sa/further-details?matchId=<matchId>{&startDate,endDate}"),
